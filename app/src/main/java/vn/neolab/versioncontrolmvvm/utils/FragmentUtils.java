...
public class FragmentUtils {
    ...
    public static void replaceFragment(AppCompatActivity activity, Class<? extends BaseFragment> claz,
                                       int id, boolean addToBackStack, Bundle arg) {
        replaceFragment(activity, claz, null, id, addToBackStack, arg);
    }


    public static void replaceFragment(Class<? extends BaseFragment> claz, Fragment parentFragment,
                                       int id, boolean addToBackStack, Bundle arg) {
        replaceFragment(null, claz, parentFragment, id, addToBackStack, arg);
    }

    private static void replaceFragment(AppCompatActivity activity, Class<? extends BaseFragment> claz, Fragment parentFragment,
                                        int id, boolean addToBackStack, Bundle arg) {
    ...
    private static boolean isFragmentShown(AppCompatActivity activity, Class<? extends BaseFragment> claz, int id, Fragment parentFragment) {
